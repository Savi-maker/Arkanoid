...
*/
template <class T1, class T2> bool isIntersecting5(T1& A, T2& B)
{
...
*/
bool collisionTest5(Paddle& paddle, Ball& ball)
{
...
*/
bool collisionTest5(Block& block, Ball& ball)
{
    if (!isIntersecting5(block, ball))
        return false;
...
int Poziom5::Start()
{
    ...
    Sprite sprite111;
    SoundBuffer buffer;
    buffer.loadFromFile("Audio/level5Audio.wav");
    Sound sound;
    ...
    Texture Poziom5;
    Poziom5.loadFromFile("Textury/level5.png");
    Sprite sprite5;
    sprite5.setTexture(Poziom5);
